...
<body id="body">
	<div id="body">
		...
		<div id="ad_info" align=center>
			<ul>
				<li>±§∞Ì¿Ã∏ß=${adinfo.adsubject }</li>
				<li>±§∞ÌªÁ¿Ã∆Æ=${adinfo.url }</li>
				<li>±§∞Ì¡÷=${adinfo.adid }</li>
				<li>∆˜¿Œ∆Æ=${adinfo.pointrange }</li>
				<li>∞Ê«∞=${adinfo.presentrange }</li>
			</ul>
		</div>
		<div id="ad_msg">
		...
		<div id="ad_comment" align=center>
			<table border=0 width=400>
				<tr>
					<td align=right>
						<button id="replyShow">¥Ò±€ø≠±‚</button>
					</td>
				</tr>
			</table>
			<div id="reply">
            ...
            ¶¶ <a href="#" class="re_re_a" name="${rDto.no }">¥Ò±€</a>&nbsp;
             ...
             ¶¶ <a href="#" class="re_up_a" name="${rDto.no }">ºˆ¡§</a>&nbsp;¶¶ <a
											href="reply_delete.do?no=${rDto.no }&bno=${d.no}&page=${curpage}">ªË¡¶</a>
									</c:if>
								</c:if></td>
						</tr>
						<tr id="re_re_write${rDto.no }" style="display: none">
							<td colspan="2"><form method=post
									...
									<span
										...
										type="button" value="¥Ò±€" style="height: 50px"
								...
								<form method=post
									...
									<span style="display: block; float: left; height: 50px">
										...
										<textarea rows="3" cols="55" name=rmsg id=rmsg
											style="vertical-align: middle;"></textarea> <input
										type="hidden" name="bno" value="${curpage }"> <%-- <input type="hidden" name="page" value="${curpage }"> --%>
										<input type="button" value="¥Ò±€" style="height: 50px"
										id="reWriteBtn">
